...
async def test_adaptive_auto_dampen(  # noqa: C901
    ...
    try:
        ...
        await _wait_for_it(hass, caplog, freezer, "Task dampening load_history took")
...
async def test_select_comparison_interval_single_factor(
    ...
    try:
        ...
        solcast.dampening.auto_factors_history = {0: {0: [{"period_start": day_start, "factors": factors}]}}
